    ...
    <nav class="navbar navbar-default" id="header-nav-middle">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${pageContext.request.contextPath}/main"><span class="logo-word">温馨花店</span></a>
            </div>
            ...
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li><a class="a-color" href="${pageContext.request.contextPath}/category?cateId=${categorys.cateid}&cate=${categorys.catename}">${categorys.catename}</a></li>
                    </c:forEach>
                </ul>
