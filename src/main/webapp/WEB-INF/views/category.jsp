                        ...
                        <nav aria-label="Page navigation">
                            <ul class="pagination pagination-lg">
                                ...
                                <c:if test="${pageInfo.hasPreviousPage}">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/search?cateid=${key}&page=${pageInfo.prePage}" aria-label="Previous">
                                ...
                                <c:forEach items="${pageInfo.navigatepageNums}" var="pageNums">
                                    <c:if test="${pageNums == pageInfo.pageNum}">
                                        <li class="active"><a href="${pageContext.request.contextPath}/search?cateid=${key}&page=${pageNums}">${pageNums}</a></li>
                                    </c:if>
                                    <c:if test="${pageNums != pageInfo.pageNum}">
                                        <li><a href="${pageContext.request.contextPath}/search?cateid=${key}&page=${pageNums}">${pageNums}</a></li>
                                    </c:if>
                                </c:forEach>

                                <c:if test="${pageInfo.hasNextPage}">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/search?cateid=${key}&page=${pageInfo.nextPage}" aria-label="Next">
